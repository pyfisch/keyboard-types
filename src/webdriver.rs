...
//! ```
//!
//! Specification: <https://www.w3.org/TR/webdriver2/>
...
// Spec: <https://www.w3.org/TR/webdriver2/#keyboard-actions>
...
/// Spec: <https://www.w3.org/TR/webdriver2/#dfn-code>
...
///
/// Spec: <https://www.w3.org/TR/webdriver2/#dfn-key-input-state>
...
impl KeyInputState {
    ...
    ///
    /// Specification: <https://www.w3.org/TR/webdriver2/#dfn-dispatch-a-keydown-action>
    ...
    ///
    /// Specification: <https://www.w3.org/TR/webdriver2/#dfn-dispatch-a-keyup-action>
...
///
/// Spec: <https://www.w3.org/TR/webdriver2/#element-send-keys>
pub fn send_keys(text: &str) -> Vec<Event> {
    ...
    /// Spec: <https://www.w3.org/TR/webdriver2/#dfn-typeable>
